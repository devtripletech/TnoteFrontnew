...
export const getEmployeesAction = async (): Promise<Employee[]> => {
  return getToken().then(async (token) => {
    try {
      const res = await fetch(`http://54.162.218.30:3000/funcionario`, {
        method: "GET",
        headers: {
...
> => {
  return getToken().then(async (token) => {
    try {
      const res = await fetch(`http://54.162.218.30:3000/cargo`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
export const getEmployeeHoursAction = async (): Promise<EmployeeHours[]> => {
  return getToken().then(async (token) => {
    try {
      const res = await fetch(`http://54.162.218.30:3000/horario`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
export const getEmployeeCityAction = async (): Promise<EmployeeCity[]> => {
  return getToken().then(async (token) => {
    try {
      const res = await fetch(`http://54.162.218.30:3000/cidade`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  return getToken().then(async (token) => {
    try {
      const res = await fetch(
        `http://54.162.218.30:3000/funcionario/${employeeId}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export async function editEmployeeAction(
  ...
  return getToken().then(async (token) => {
    try {
      const res = await fetch(
        `http://54.162.218.30:3000/funcionario/${input.ID_funcionario}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
...
export const getManagerAction = async (): Promise<TechnicalManager[]> => {
  return getToken().then(async (token) => {
    try {
      const res = await fetch(`http://54.162.218.30:3000/projetosgerente`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
